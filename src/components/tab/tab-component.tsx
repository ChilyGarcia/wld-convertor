...
import CoinCard from '@/components/trading-bot/coin-card';
    ...
    <Tab.Group>
      <div className="flex items-start">
        ...
        <div className="-mb-4 flex h-full min-h-[36px] w-full items-start overflow-hidden xs:mb-0">
          <Tab.List
            ref={sliderEl}
            className="coin-list-scrollbar relative flex w-full justify-between overflow-x-auto scroll-smooth border-b border-gray-200 text-sm dark:border-gray-800 min-[375px]:justify-start min-[375px]:gap-6 xs:mb-0 2xl:gap-10"
          >
